...
**Plans**: 5 plans
- [x] 04-01-PLAN.md — Service route template src/pages/[service].astro (Wave 1)
- [x] 04-02-PLAN.md — Neighborhood route template src/pages/[neighborhood]-barber.astro (Wave 1)
...
**Plans**: 11 plans
- [x] 06-01-PLAN.md — CR-02 fix: guard aggregateRating against empty input (Wave 1)
- [x] 06-02-PLAN.md — CR-03 fix: reorder validate-schema preflight with existsSync (Wave 1)
- [x] 06-03-PLAN.md — CR-04 fix: add publisher.url + logo ImageObject to Article schema (Wave 1)
- [x] 06-04-PLAN.md — D-01 fix: correct business.geo to real shop coordinates (Wave 1)
