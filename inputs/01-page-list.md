# Page List — 17–19 Pages

Architecture for Joe's E9 AEO Content Hub. Verified evidence: 20–40 focused local pages outperform both 4-page micro-sites and 200-page generic sites for local AI search (JavaLogix Toronto plumber playbook + corroborating sources).
...
| 6 | `/beard-trim` | Service + FAQPage | $20 line-up. |
| 7 | `/hot-towel-shave` | Service + FAQPage | $30. |
| 8 | `/line-up` | Service + FAQPage | $20. |
| 9 | `/classic-cut` | Service + FAQPage | $30. |
| 10 | `/bostonia-barber` | LocalBusiness with `areaServed` + FAQPage | **Micro-neighborhood** (NOT generic city page). Landmarks + 3–4 neighborhood-specific FAQs. |
| 11 | `/el-cajon-barber` | same | |
| 12 | `/santee-barber` | same | |
...
For Open Design generation, **5 unique templates**:

1. **Homepage template** (page 1)
2. **Niche-query landing template** (page 3)
3. **Service template** (pages 4–9 share — content swap)
4. **Neighborhood template** (pages 10–14 share — content swap)
5. **Article / cost-guide template** (page 15, page 19 reuse)
6. **FAQ template** (page 16)
7. **Reviews / about template** (pages 2 and 17 share variant)

Generate 5–7 mocks. The other 12 pages are content swaps within those templates.
